...
def run_with_base_class():
    ...
    wterfclty_mc.set_parameter("result_name", result_name)  # name of csv file with results
    wterfclty_mc.run()
    ...
    epf_mc.set_parameter("result_name", result_name)  # name of csv file with results
    epf_mc.run()
    ...
    pipeline_func.set_parameter("result_name", result_name)
