...
def run_with_base_class():
    ...
    epf_dmg_eq_memphis.set_parameter("result_name", "memphis_eq_epf_dmg_result_w_hazard_obj")
    ...
    epf_dmg_tsu_re.set_parameter("result_name", "seaside_tsunami_epf_dmg_result_w_hazard_obj")
    ...
    # Run epf damage
    hurricane = Hurricane.from_hazard_service("5fa472033c1f0c73fe81461a", hazard_service)
    epf_dmg_hurricane_galveston = EpfDamage(client)
    epf_dmg_hurricane_galveston.load_remote_input_dataset("epfs", "62fd437b18e50067942b679a")
    ...
    epf_dmg_hurricane_galveston.set_parameter("result_name", "galveston_hurricane_epf_damage_w_hazard_obj")
