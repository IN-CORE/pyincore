...
def run_with_base_class():
    ...
    # epf_dataset = Dataset.from_file("LumbertonNC_substations.shp", data_type="incore:epf")
    # epa_lumberton.set_input_dataset("epfs", epf_dataset)

    epf_damage_result = Dataset.from_file("lumberton_flood_epf.csv", data_type="incore:epfDamageVer3")
