...
from pyincore.analyses.nonstructbuildingdamage import (
...
def run_with_base_class():
    ...
    non_structural_building_dmg_as.set_parameter(
        "result_name", "non_structural_building_dmg_result_w_hazard_obj_as"
    )
    non_structural_building_dmg_as.set_parameter("num_cpu", 4)
    non_structural_building_dmg_as.set_parameter(
        "fragility_key", NonStructBuildingUtil.DEFAULT_FRAGILITY_KEY_AS
    )
    ...
    non_structural_building_dmg_ds.set_parameter(
        "result_name", "non_structural_building_dmg_result_w_hazard_obj_ds"
    )
    non_structural_building_dmg_ds.set_input_hazard("hazard", earthquake)
    non_structural_building_dmg_ds.set_parameter("num_cpu", 4)
    non_structural_building_dmg_ds.set_parameter(
        "fragility_key", NonStructBuildingUtil.DEFAULT_FRAGILITY_KEY_DS
    )
