...
def run_with_base_class():
    ...
    wf_repair_cost.load_remote_input_dataset(
        "water_facilities", "647644fe5bc8b26ddf9c5ddb"
    )  # dev

    wf_repair_cost.load_remote_input_dataset(
        "replacement_cost", "647645c75bc8b26ddf9c8f66"
    )

    # can be chained with MCS
    wf_repair_cost.load_remote_input_dataset(
        "sample_damage_states", "647646bb5bc8b26ddf9cb775"
    )

    # dmg ratiose
    wf_repair_cost.load_remote_input_dataset(
        "wf_dmg_ratios", "647646705bc8b26ddf9cb747"
    )
