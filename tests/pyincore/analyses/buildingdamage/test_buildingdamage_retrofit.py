...
from pyincore import IncoreClient, MappingSet, Tornado, Dataset, HazardService, Flood, FragilityService
...
def run_with_base_class():
    ...
    sw_bldg_dmg_retrofit.load_remote_input_dataset("buildings", "63ff6b135c35c0353d5ed3ac")

    # Surge-wave mapping
    mapping_id = "6303e51bd76c6d0e1f6be080"
    mapping_set = MappingSet(fragility_service.get_mapping(mapping_id))

    retrofit_plan_dataset = Dataset.from_file("/Users/cwang138/Downloads/all_building_10_feet_elevated.csv",
                                              "incore:retrofitStrategy")
    sw_bldg_dmg_retrofit.set_input_dataset('retrofit_strategy', retrofit_plan_dataset)
    ...
    sw_bldg_dmg_retrofit.set_parameter("hazard_type", "hurricane")
    sw_bldg_dmg_retrofit.set_parameter("hazard_id", "5fa5a228b6429615aeea4410")
