...
def run_with_base_class():
    ...
    bldg_dmg.load_remote_input_dataset("buildings", "63053e74c8f8b7614f6cff9f")
    ...
    fragility_service = FragilityService(client)
    mapping_set = MappingSet(fragility_service.get_mapping(flood_mapping_id))
    bldg_dmg.set_input_dataset('dfr3_mapping_set', mapping_set)
    ...
    fragility_service = FragilityService(client)
    mapping_set = MappingSet(fragility_service.get_mapping(sw_mapping_id))
    bldg_dmg.set_input_dataset('dfr3_mapping_set', mapping_set)
