...
paths = [
    ...
    os.path.join(PYINCORE_ROOT_FOLDER, 'tests/pyincore/utils/test_dataprocessutil.py'),
    os.path.join(PYINCORE_ROOT_FOLDER, 'pyincore/utils/datasetutil.py'),
    os.path.join(PYINCORE_ROOT_FOLDER, 'tests/pyincore/utils/test_datasetutil.py'),
    ...
    os.path.join(PYINCORE_ROOT_FOLDER, 'pyincore/analyses/housingrecovery/'),
    os.path.join(PYINCORE_ROOT_FOLDER, 'tests/pyincore/analyses/housingrecovery/')
]
