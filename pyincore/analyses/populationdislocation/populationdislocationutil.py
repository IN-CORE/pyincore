...
class PopulationDislocationUtil:
    ...
    @staticmethod
    def merge_damage_population_block(building_dmg_file, population_allocation_file,
                                      block_data_file, use_prob_damages=False):
        """
        ...
        Args:
            ...
            use_prob_damages: Flag to use probablistic hazard values provided by the
            input dataset, instead of building_dmg_file generated by hazard service.
            Setting it to True means not using the building damage results altogether.
        ...
        if use_prob_damages:
            building_dmg = building_dmg.drop(columns=damage_states)
        else:
