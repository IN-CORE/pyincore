...
class BuildingDirectEconDamage(BaseAnalysis):
    ...
    def __init__(self, incore_client):
		...
		self.buildingNSContentDamageV4 = None
		self.occupancyDamageMultipliers = None
		self.inflationTable = None
		self.defaultInflationFactor = None
		self.nonStructuralDamageMap = None

		self.str_loss = None
		self.str_loss_dev = None
		self.acc_loss = None
		self.acc_loss_dev = None
		self.dri_loss = None
		self.dri_loss_dev = None
		self.con_loss = None
		self.con_loss_dev = None
		self.tot_loss = None
		self.tot_loss_dev = None
	...
	def __preProcess():
		...
		tot_loss = 0.0
		tot_loss_dev = 0.0
		if buildingNSContentDamageV4 is not None:
