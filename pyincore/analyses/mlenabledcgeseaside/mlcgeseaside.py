...
class MlEnabledCgeSeaside(CoreCGEML):
    """
    The Machine Learning Enabled Computable General Equilibrium (CGE) - Seaside analysis merges advanced machine
    learning with traditional CGE models to offer unprecedented insights into the economic impacts of disaster
    scenarios on Seaside. Trained on a comprehensive dataset of numerous simulated disasters and their economic
    ...
    model = "Machine Learning Enabled Computable General Equilibrium - Seaside"
    ...
    def get_spec(self):
        return {
            "name": "Seaside-small-calibrated",
            "description": "The “Machine Learning Enabled Computable General Equilibrium (CGE) - Seaside” analysis merges advanced"
            " machine learning with traditional CGE models to offer unprecedented insights into the economic impacts of disaster "
            "scenarios on Seaside. Trained on a comprehensive dataset of numerous simulated disasters and their economic effects, "
