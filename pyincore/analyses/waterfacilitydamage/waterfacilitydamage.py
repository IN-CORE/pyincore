...
class WaterFacilityDamage(BaseAnalysis):
    ...
    def waterfacilityset_damage_analysis(self, facilities, hazard_type,
        ...
        if hazard_type == 'earthquake':
            ...
            pga_fragility_set = self.fragilitysvc.map_fragilities(mapping_id,
                                                                  facilities,
                                                                  fragility_key)
            ...
            if use_liquefaction and liq_geology_dataset_id is not None:
                ...
                liq_fragility_set = self.fragilitysvc.map_fragilities(
            ...
            inundation_fragility_set = self.fragilitysvc.map_fragilities(
