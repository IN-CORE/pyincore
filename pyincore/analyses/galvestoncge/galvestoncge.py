...
class GalvestonCGEModel(BaseAnalysis):
    ...
    def galveston_cge(self, iNum, sam, bb, jobcr, misch, employ, outcr, sector_shocks):
        ...
        Z = ['IAGMIN', 'IUTIL', 'ICONS', 'IMANU', 'IWHOLE', 'IRETAIL', 'ITRANS', 'IPROFSER', 'IREALE', 'IEDU',
             'IHEALTH', 'IART', 'IACCO',
        ...
        # INDUSTRY SECTORS
        I = ['IAGMIN', 'IUTIL', 'ICONS', 'IMANU', 'IWHOLE', 'IRETAIL', 'ITRANS', 'IPROFSER', 'IREALE', 'IEDU',
             'IHEALTH', 'IART', 'IACCO',
             'MAGMIN', 'MUTIL', 'MCONS', 'MMANU', 'MWHOLE', 'MRETAIL', 'MTRANS', 'MPROFSER', 'MREALE', 'MEDU',
             'MHEALTH', 'MART', 'MACCO',
             'HS1I', 'HS2I', 'HS3I', 'HS1M', 'HS2M', 'HS3M']
        ...
        # PRODUCTION SECTORS
        IP = ['IAGMIN', 'IUTIL', 'ICONS', 'IMANU', 'IWHOLE', 'IRETAIL', 'ITRANS', 'IPROFSER', 'IREALE', 'IEDU',
              'IHEALTH', 'IART', 'IACCO',
              'MAGMIN', 'MUTIL', 'MCONS', 'MMANU', 'MWHOLE', 'MRETAIL', 'MTRANS', 'MPROFSER', 'MREALE', 'MEDU',
              'MHEALTH', 'MART', 'MACCO']
