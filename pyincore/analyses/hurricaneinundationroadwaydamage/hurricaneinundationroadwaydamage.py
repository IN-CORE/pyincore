...
"""Galveston Road Damage Analysis subjected to Inundation
...
from pyincore.analyses.hurricaneinundationroadwaydamage.roadwayutil import \
    RoadwayUtil


class HurricaneInundationRoadwayDamage(BaseAnalysis):
    ...
    def __init__(self, incore_client):
        ...
        super(HurricaneInundationRoadwayDamage, self).__init__(incore_client)
