...
class MlEnabledCgeLumberton(CoreCGEML):
    """
    The Machine Learning Enabled Computable General Equilibrium (CGE) - Lumberton analysis merges advanced machine
    learning with traditional CGE models to offer unprecedented insights into the economic impacts of disaster
    scenarios on Lumberton. Trained on a comprehensive dataset of numerous simulated disasters and their economic
    ...
    model = "Machine Learning Enabled Computable General Equilibrium - Lumberton"
    ...
    def __init__(self, incore_client: IncoreClient):
        ...
        super(MlEnabledCgeLumberton, self).__init__(
            incore_client, sectors, labor_groups=labor_grps
        )  # 4 labor groups

    def run(self) -> bool:
        """
        Executes the ML enabled CGE model for Lumberton.

        Returns:
            bool: True if the model runs successfully, False otherwise.
        """
    ...
    def get_spec(self):
        return {
            "name": "Lumberton-small-calibrated",
            "description": "The “Machine Learning Enabled Computable General Equilibrium (CGE) - Lumberton analysis merges advanced"
            " machine learning with traditional CGE models to offer unprecedented insights into the economic impacts of disaster "
            "scenarios on Lumberton. Trained on a comprehensive dataset of numerous simulated disasters and their economic effects, "
            "this hybrid approach excels in predicting the intricate dynamics of the city’s economy under various crises.",
            "input_parameters": [
                {
                    "id": "result_name",
                    "required": False,
